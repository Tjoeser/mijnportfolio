...
class ContentController
{
	...
	public function home()
	{
		...
		$html .= ' <div id="mobilecarddivver" class="carddivver">';
		...
		$html .= "    <p>
                        ...
                        Zo hou ik ook met elke nieuwe film mijn <a target='_blank' id='textlink' href='https://letterboxd.com/Tjoeser/'>Letterboxd</a> bij.<br><br>
		...
		$html .= '  <div class="card" id="largeimgdiv">';
		...
		$html .= '  <div class="card">';
		$html .= '    <h2 class="centerh1" id="projectencard">Projecten</h2>';
		$html .= '  <div class="nestedcard">';
		$html .= ' <div class="carddivver">';
		$html .= $this->card(0, "TheFilmTon");
		$html .= '  </div>';
		$html .= '  </div>';
		$html .= '</div>';
		$html .= '</div>';
...
Uiteindelijk hebben we vanwege coronaomstandigheden besloten toch onze wegen te splitsen.<br><br>
		...
		$html .= '  </div>';
		$html .= '              <div class="nestedcard">';
		$html .= '                  <h3 class="centerh">Pathe Utrecht Leidsche rijn</h3>';
...
Om het samen te vatten: ik heb leuke mensen ontmoet en mijn passie voor programmeren erg goed kunnen aanwakkeren.<br><br>
		...
		$html .= '<input type="text" id="fname" name="fname" placeholder="voornaam..."></div>';
		$html .= '<div><label for="lname">Achternaam</label>';
		$html .= '<input type="text" id="lname" name="lastname" placeholder="achternaam..."></div>';
		...
		$html .= '<input type="text" id="email" name="email" placeholder="e-mailadres..."></div>';
		$html .= '<div><label for="company">Bedrijf</label>';
		$html .= '<input type="text" id="company" name="company" placeholder="bedrijfsnaam..."></div>';
		...
		switch ($titel) {
			case 'Mijn Portfolio Website':
				...
				$cont = '
                        ...
                        Mijn portfolio website heeft een eigen<br> <a target="_blank" id="textlink" href="https://github.com/Tjoeser/mijnportfolio">GitHub-repository</a>.<br>
			...
			case 'TheFilmTon':
                ...
                <div class='carddivver'>
                        <div class='nestedcard2'>
                            Na jaren van leren en oefenen had ik eindelijk genoeg kennis om een echte website te maken.<br><br>
                            Nou ja, was het maar zo simpel.<br><br>
                            Al een hele tijd was ik op zoek naar een website met specifieke functionaliteiten.<br>
                            Die kon ik echter nergens vinden; het enige wat in de buurt kwam, was <a target='_blank' id='textlink' href='https://letterboxd.com/'>Letterboxd</a>.<br><br>
                            Letterboxd is een handige app en website, maar naar mijn mening kon het beter.<br><br>
                            Zo ontstond het idee voor <a target='_blank' id='textlink' href='https://thefilmton.com/'>TheFilmTon</a>.<br><br>
                            TheFilmTon is een website waar je films en series kunt ontdekken, reviews kunt schrijven en een watchlist kunt bijhouden.<br>
                            Daarnaast is er een meldingssysteem: je krijgt een melding zodra een film die je wilt zien beschikbaar is op een streamingdienst die jij hebt.<br><br>
                            Ik heb nog veel ideeën voor deze website, maar helaas ben ik een eenmansteam.<br>
                            TheFilmTon is mijn passieproject, het spookt al jaren door mijn hoofd, en ik ben nog lang niet klaar.<br><br>
                        </div>
                        ";
				return $this->cardtje($pic, $tit, $cont);
				break;
			case 'Examen jaar op school':
                ...
                <div class='carddivver'>
                        <div class='nestedcard2'>
                            Op school had ik een project gekregen genaamd <a target='_blank' id='textlink' href='https://github.com/Tjoeser/MVC'>'MVC'</a>.<br><br>
                        ...
                        <div class='nestedcard2'>
                            Na dat MVC duidelijk was, kregen wij de opdracht om dit <a target='_blank' id='textlink' href='https://github.com/Tjoeser/react-native_mvc'>ook voor mobiel te maken.</a><br><br>
			...
			case 'Stenniz workshop stage':
				...
				$cont = "
                        <div class='nestedcard2'>
                            Tijdens mijn stage bij Stenniz Workshops heb ik een <a target='_blank' id='textlink' href='https://github.com/Tjoeser/mvc_stagesite'>GitHub-repository</a> gekregen om aan te werken.<br><br>
